...
double Fugacity::h2_fugacity(double temperature, double pressure) {
	...
	if((temperature == 77.0) && (pressure <= 200.0)) {
		...
		return h2_fugacity_zhou( pressure );
	}  
...
double Fugacity::h2_fugacity_zhou(double pressure) {
...
double Fugacity::n2_fugacity_zhou( double pressure ) {
...
double Fugacity::get_peng_robinson_fugacity(double temperature, double pressure, std::string species) {
